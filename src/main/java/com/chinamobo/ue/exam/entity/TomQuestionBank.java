...
public class TomQuestionBank {
	...
	private List<TomTopic>handQuestions ;
	

	public List<TomTopic> getHandQuestions() {
		return handQuestions;
	}

	public void setHandQuestions(List<TomTopic> handQuestions) {
		this.handQuestions = handQuestions;
	}

	@FormParam("topicNameList[]")
	...
	@FormParam("RightCellList[]")
	private List<String>RightCellList;
	
	
	public List<String> getRightCellList() {
		return RightCellList;
	}

	public void setRightCellList(List<String> rightCellList) {
		RightCellList = rightCellList;
	}
